...
$questions = $_POST['questions'] ?? $questions ?? [
    [
        'text' => '',
        'option_a' => '',
        'option_b' => '',
...
<head>
    <meta charset="UTF-8">
    <title>Buat Tantangan Baru - StudyTrack</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="form-container">
                ...
                <?php endif; ?>
                <form method="POST" action="/challenge/create">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="category" name="category" value="<?= htmlspecialchars($category ?? '') ?>" placeholder="Contoh: PPKN, Matematika, Bahasa Indonesia">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="difficulty" name="difficulty" required>
                            <option value="" disabled <?= empty($difficulty) ? 'selected' : '' ?>>Pilih tingkat kesulitan</option>
                            <option value="Low" <?= ($difficulty ?? '') === 'Low' ? 'selected' : '' ?>>Low - Mudah</option>
                            <option value="Medium" <?= ($difficulty ?? '') === 'Medium' ? 'selected' : '' ?>>Medium - Sedang</option>
                            <option value="High" <?= ($difficulty ?? '') === 'High' ? 'selected' : '' ?>>High - Sulit</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="week">Minggu</label>
                        <input type="number" id="week" name="week" min="1" value="<?= htmlspecialchars($week ?? $current_week) ?>" required>
                    </div>
                    <button type="submit" class="btn-primary">Simpan Tantangan</button>
                </form>
